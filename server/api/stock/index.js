...
router.patch('/',  controller.update); //Admin only, Updates the stock's price?? TODO: are we using this?
router.delete('/', auth.hasRole('admin'), controller.destroy); //Admin only, Delete's all stocks for DEV purposes
